...
\begin{section}{\Large Education}
    ...
    \begin{subsectionnobullet}{\underline{Master of Science, University of Basel}}{Biozentrum}{Basel, Switzerland}{Sep. 2024 -- Jan. 2026 (expected)}
        \italicitem{\textbf{Major}: Master of Science in Physics of Life (fellowship)}
    \end{subsectionnobullet}


    \begin{subsectionnobullet}{\underline{Bachelor of Science in Physics, Lanzhou University }(Project 985 in China)}{One of China's top 10 science universities}{Lanzhou, China}{Sep. 2020 -- Jul. 2024}
    % \vspace{1mm}
        \italicitem{\textbf{Major}: Physics (magnetic track )\textcolor{gray}{\small in {National Training Base for Research and Teaching Talents in Basic Science Disciplines}}}\vspace{1mm}
        \italicitem{\textbf{Ranking}: 4/20 (20 Selected from 52) \hspace{5mm}  \textbf{GPA}: 85.25/100
}
...
\sectiontable{\Large Honors and Awards}{
    \entry{Biozentrum Fellowship for Master's Study in Physics of Life}{ \hfill \textit{Jun. 2024}}
...
\sectiontable{\Large Skills}{
    ...
    \entry{Software:}{
        Familiar with Comsol, SolidWorks, Zemax, PixInsight; Proficient in Adobe Illustrator, Photoshops
    }
